...
export default function Topbar({
  ...
  const handleSearchKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'Enter' && searchQuery.trim() && currentPage === 'dashboard' && onNavigate) {
      // Navigate to users page when Enter is pressed on dashboard
      onNavigate('users');
      // Focus will be handled by Users page when it mounts
    }
  };
